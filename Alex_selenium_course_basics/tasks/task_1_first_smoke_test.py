...
try:
    ...
    price_product_1 = driver.find_element(By.XPATH,
                                          "//button[@id='add-to-cart-sauce-labs-backpack']/preceding-sibling::div")
    ...
    price_product_2 = driver.find_element(By.XPATH,
                                          "//button[@id='add-to-cart-sauce-labs-bolt-t-shirt']/preceding-sibling::div")
    ...
    cart_price_product_1 = driver.find_element(By.XPATH,
                                               "//button[@id='remove-sauce-labs-backpack']/preceding-sibling::div")
    ...
    cart_price_product_2 = driver.find_element(By.XPATH,
                                               "//button[@id='remove-sauce-labs-bolt-t-shirt']/preceding-sibling::div")
    ...
    finish_price_product_1 = driver.find_element(By.XPATH,
                                                 "//a[@id='item_4_title_link']/following-sibling::div[@class='item_pricebar']")
    ...
    finish_price_product_2 = driver.find_element(By.XPATH,
                                                 "//a[@id='item_1_title_link']/following-sibling::div[@class='item_pricebar']")
